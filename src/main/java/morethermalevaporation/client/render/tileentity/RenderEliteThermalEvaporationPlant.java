...
public class RenderEliteThermalEvaporationPlant extends MultiblockTileEntityRenderer<EliteThermalEvaporationMultiblockData, TileEntityEliteThermalEvaporationController> {

    public RenderEliteThermalEvaporationPlant(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void render(TileEntityEliteThermalEvaporationController tile, EliteThermalEvaporationMultiblockData multiblock, float partialTick, PoseStack matrix, MultiBufferSource renderer,
    ...
    protected String getProfilerSection() {
        return "EliteThermalEvaporationController";
    }

    @Override
    protected boolean shouldRender(TileEntityEliteThermalEvaporationController tile, EliteThermalEvaporationMultiblockData multiblock, Vec3 camera) {

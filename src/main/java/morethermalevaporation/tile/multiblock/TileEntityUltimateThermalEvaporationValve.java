...
public class TileEntityUltimateThermalEvaporationValve extends TileEntityUltimateThermalEvaporationBlock {

    public TileEntityUltimateThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationBlocks.ULTIMATE_THERMAL_EVAPORATION_VALVE, pos, state);
    }
    ...
    public @NotNull Component getDisplayName() {
        return TextComponentUtil.color(super.getDisplayName().copy(), BaseTier.ULTIMATE.getColor().getValue());
    }
}
...
public class AdvancedThermalEvaporationMultiblockData extends MultiblockData implements IValveHandler, FluidRecipeLookupHandler<FluidToFluidRecipe> {
    ...
    public AdvancedThermalEvaporationMultiblockData(TileEntityAdvancedThermalEvaporationBlock tile) {
        super(tile);
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<AdvancedThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(AdvancedThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            AdvancedThermalEvaporationMultiblockData multiblockData = multiblock.get();

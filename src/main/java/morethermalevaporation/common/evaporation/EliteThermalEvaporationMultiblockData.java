...
public class EliteThermalEvaporationMultiblockData extends MultiblockData implements IValveHandler, FluidRecipeLookupHandler<FluidToFluidRecipe> {

    public static final int MAX_HEIGHT = 18;
    public static final double MAX_MULTIPLIER_TEMP = 24_000;
    ...
    public EliteThermalEvaporationMultiblockData(TileEntityEliteThermalEvaporationBlock tile) {
        super(tile);
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, MoreThermalEvaporationConfig.EliteEvaporationOutputTankCapacity::get, BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<EliteThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(EliteThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            EliteThermalEvaporationMultiblockData multiblockData = multiblock.get();
